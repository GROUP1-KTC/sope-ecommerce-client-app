  ...
  return (
    <div>
      ...
      <div className="space-y-4">
        <div>
          <label className="text-sm block mb-1 font-medium">Loại giấy tờ</label>
          <div className="relative">
            <select
              value={idType}
              onChange={(e) => setIdType(e.target.value as "CITIZEN_IDENTIFICATION" | "PASSPORT")}
            ...
            >
              <option value="CITIZEN_IDENTIFICATION">Chứng minh nhân dân / Căn cước</option>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <input
              ...
              id="id-front-upload"
              className="hidden"
              onChange={(e) => handleFileChange(setIdFront, () => { }, e)}
            />
            <label
          ...
          <div>
            ...
            <input
              ...
              id="id-back-upload"
              className="hidden"
              onChange={(e) => handleFileChange(setIdBack, () => { }, e)}
            />
            <label
          ...
          <div>
            ...
            <input
              ...
              id="selfie-upload"
              className="hidden"
              onChange={(e) => handleFileChange(setSelfie, () => { }, e)}
            />
            <label
