    ...
    return (
        <aside className="w-60 bg-gray-50 rounded-lg p-4 text-sm flex-shrink-0">
            ...
            <ul className="list-none pl-4 border-l-2 border-orange-300 ml-1 mt-2 leading-relaxed text-gray-600">
                <li className="pl-2 text-orange-600 font-medium">Khuyến Mãi</li>
                <li className="pl-2">Cập Nhật Đơn Hàng</li>
                <li className="pl-2">Cập Nhật Ví</li>
                <li className="pl-2">Cập Nhật Naver</li>
            </ul>
            ...
            <ul className="list-none pl-4 border-l-2 border-blue-300 ml-1 mt-2 leading-relaxed text-gray-600">
                <li className="pl-2">Hồ Sơ</li>
                <li className="pl-2">Ngân Hàng</li>
                <li className="pl-2">Địa Chỉ</li>
                <li className="pl-2">Đổi Mật Khẩu</li>
                <li className="pl-2">Cài Đặt Thông Báo</li>
                <li className="pl-2">Thiết Lập Riêng</li>
                <li className="pl-2">Thông Tin Cá Nhân</li>
            </ul>
