...
interface PasswordStepProps {
  input: { fullName: string; gender: string; password: string; confirmPassword: string };
  errors: { fullName: string; gender: string; password: string; confirmPassword: string };
  showPassword: boolean;
  setShowPassword: (value: boolean) => void;
  showConfirmPassword: boolean;
  setShowConfirmPassword: (value: boolean) => void;
  changeEventHandler: (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => void;
    ...
    <form onSubmit={handleSignupSubmit} className="mt-6 space-y-4">
      ...
      <div>
        ...
        <div className="relative flex items-center">
          ...
          >
            {showConfirmPassword ? <EyeOff size={16} color="#bbb" /> : <Eye size={16} color="#bbb" />}
          </span>
