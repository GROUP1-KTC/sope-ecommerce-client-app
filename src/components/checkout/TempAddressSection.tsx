  ...
  return (
    <div className="bg-gray-50 p-4 rounded-lg shadow mb-6">
      ...
      <div className="space-y-4">
        ...
        {/* Phone */}
        <div className="flex items-center">
          <label className="w-1/4 text-sm font-bold">Số điện thoại</label>
          <input
            type="tel"
            name="phone"
        ...
        {/* Province */}
        <div className="flex items-center">
          <label className="w-1/4 text-sm font-bold">Tỉnh/Thành phố</label>
          <select
            name="province"
        ...
        {/* District */}
        <div className="flex items-center">
          <label className="w-1/4 text-sm font-bold">Quận/Huyện</label>
          <select
            name="district"
        ...
        {/* Detailed Address */}
        <div className="flex items-center">
          <label className="w-1/4 text-sm font-bold">Địa chỉ chi tiết</label>
          <input
            type="text"
