...
const HeaderCustomService = () => {
    return (
        <div className="w-full">
            ...
            {/* Main Section */}
            <div className="bg-[#ee4d2d] flex flex-col items-center py-16">
                <h1 className="text-white text-4xl font-medium mb-10 text-center">
                    Xin chào, Shopee có thể giúp gì cho bạn?
                </h1>
                <div className="w-full max-w-3xl flex items-center bg-white rounded-md overflow-hidden shadow-md">
                    <input
                        type="text"
                        placeholder="Nhập từ khóa hoặc nội dung cần tìm"
                        className="flex-1 px-6 py-4 text-lg outline-none bg-transparent"
                    />
                    <button className="h-full px-8 flex items-center justify-center text-[#ee4d2d] text-2xl border-l border-gray-200 focus:outline-none">
...
export default HeaderCustomService;
