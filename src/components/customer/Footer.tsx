            ...
            <div className="max-w-7xl mx-auto px-2 sm:px-4 py-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-8 border-b-2 border-red-800">
                ...
                <div>
                    ...
                    <div className="flex flex-wrap gap-1 sm:gap-2 mb-4">
                        <div className="w-8 h-6 sm:w-10 bg-gray-200 flex items-center justify-center text-xs">
                            VISA
                        </div>
                        <div className="w-8 h-6 sm:w-10 bg-gray-200 flex items-center justify-center text-xs">
                            Master
                    ...
                    <div className="flex flex-wrap gap-1 sm:gap-2">
                        <div className="w-12 h-6 sm:w-14 bg-gray-200 flex items-center justify-center text-xs">
                            SPX
                        </div>
                        <div className="w-12 h-6 sm:w-14 bg-gray-200 flex items-center justify-center text-xs">
                            J&T
