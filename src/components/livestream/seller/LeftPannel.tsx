...
export default function LeftPanel({ liveActive, onStart, onEnd }: LeftPanelProps) {
    ...
    <div className="w-1/4 flex flex-col border-r border-gray-300 p-2 gap-3">
      ...
      <div className="flex flex-col gap-2 p-2 pt-0 bg-white rounded shadow">
        ...
        <button
          ...
          className={`mt-2 px-3 py-1 rounded font-bold text-white cursor-pointer ${liveActive ? 'bg-red-600 hover:bg-red-700' : 'bg-green-600 hover:bg-green-700'
            } transition`}
        >
