                    ...
                    <div className="bg-red-50 border border-red-200 rounded p-2 text-xs relative">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2 font-semibold text-red-600">
                                <FlashOnIcon fontSize="small" /> Đang Flash
                                Sale!
                            </div>
                            <button
                        ...
                        <div className="flex items-center gap-2 mt-1">
                            <span className="text-red-600 font-bold">
                                {flashData.price.toLocaleString('vi-VN')}₫
                            </span>
                            <span className="line-through text-gray-400">
                                {product.price.toLocaleString('vi-VN')}₫
                            </span>
                        ...
                        <div className="space-y-3 text-sm">
                            <label className="flex flex-col">
                                ...
                                <input
                                    ...
                                    value={flashPrice}
                                    onChange={(e) =>
                                        setFlashPrice(Number(e.target.value))
                                    }
                            ...
                            <label className="flex flex-col">
                                ...
                                <input
                                    ...
                                    value={flashQty}
                                    onChange={(e) =>
                                        setFlashQty(Number(e.target.value))
                                    }
                                    className="border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-400 outline-none"
                                />
                            </label>
                            ...
                            <label className="flex flex-col">
                                ...
                                <input
                                    ...
                                    value={flashDuration}
                                    onChange={(e) =>
                                        setFlashDuration(Number(e.target.value))
                                    }
                                    className="border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-400 outline-none"
                                />
                            </label>
