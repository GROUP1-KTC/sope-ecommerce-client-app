...
const ProductCard = ({ product }: { product: ProductSummary }) => {
    return (
        <CustomLink href={`/product-detail/${product.slug}`}>
            <div className="bg-white mb-1 shadow-md rounded-lg overflow-hidden hover:shadow-md transition-shadow duration-300  w-[180px] min-h-[240px] hover:scale-105 transition-transform duration-400">
                <Image
                    width={192}
                    height={144}
