...
import type { EmailRequest, LoginInput, LoginResponse, RegisterRequest, VerifyEmailRequest } from "~/types/auth/auth";
...
export const { useLoginMutation, useLogoutMutation, useSendOtpMutation, useVerifyOtpMutation, useRegisterMutation } = authApi;
