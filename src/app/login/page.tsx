...
const Login = () => {
  ...
  return (
    <div className="py-4 mt-4 flex flex-col items-center justify-center bg-white">
      {/* Logo */}
      <div className="mb-6">
        <h1 className="text-5xl font-extrabold text-green-600 tracking-wide">NAVER</h1>
      </div>
      {/* Login Box */}
      <div className="bg-white shadow-lg rounded-xl w-full max-w-md p-8 flex flex-col items-center">
        ...
        <div className="flex w-full mb-6 border-b">
          <button className="flex-1 py-2 font-semibold border-b-2 border-green-600 text-green-600">Email/Phone number</button>
          <button className="flex-1 py-2 font-semibold text-gray-400">QR code</button>
        </div>
        {/* Form */}
        ...
        <div className="w-full flex justify-center gap-2 mt-4 text-md text-gray-500">
          <a href="#" className="underline mr-2">Forget Password</a>|
        ...
        <div className="w-full flex gap-4 mt-8">
          <button className="flex-1 flex items-center justify-center gap-2 border rounded-md py-3 font-semibold bg-white shadow">
            <span className="bg-blue-600 text-white rounded px-2 py-1">f</span> Facebook
          </button>
          <button className="flex-1 flex items-center justify-center gap-2 border rounded-md py-3 font-semibold bg-white shadow">
            <span className="bg-red-500 text-white rounded px-2 py-1">GOOGLE</span> Google
          </button>
        </div>
      </div>
    </div>
