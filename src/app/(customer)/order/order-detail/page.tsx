...
const OrderDetailPage = () => {
    const order = {
        ...
        tracking: [
            ...
            { date: '08:40 01-12-2024', detail: 'Băng qua khu vực Phù Ninh - Phú Thọ' },
            { date: '07:34 01-12-2024', detail: 'Đang chờ đến lượt giao' },
            { date: '16:37 30-11-2024', detail: 'Đang vận chuyển từ kho trung tâm' },
            { date: '14:23 30-11-2024', detail: 'Đã xuất kho từ kho Phù Ninh' },
            { date: '23:30 29-11-2024', detail: 'Đã đến kho Phù Ninh' },
            { date: '23:30 29-11-2024', detail: 'Băng qua kho khu vực trung tâm' },
            { date: '23:30 29-11-2024', detail: 'Đã xuất kho từ kho trung tâm' },
            { date: '23:30 29-11-2024', detail: 'Băng qua kho khu vực địa phương' },
        ...
        items: [
            {
                ...
                imageUrl: 'https://petapixel.com/assets/uploads/2024/01/The-Star-of-System-Sol-Rectangle-640x800.jpg',
                quantity: 1,
                price: 430000,
                discount: 10000,
                total: 420000,
                    ...
                    <div className="flex-1 p-6">
                        <div className="bg-white rounded-lg shadow-md p-6">
                            <div className="flex justify-between items-center mb-6">
                                <div>
                                    <a href="/order" className="flex items-center text-xl uppercase hover:underline">
                            ...
                            <hr className="my-6 border-gray-300" />
                            <OrderTracking tracking={order.tracking} receiver={order.receiver} />
                            <hr className="my-6 border-gray-300" />
                            <OrderItems items={order.items} shop={order.shop} />
                            <OrderSummary
                                subtotal={order.items.reduce((sum, item) => sum + item.total, 0)}
                                shippingCost={50000} 
                                discount={order.items.reduce((sum, item) => sum + item.discount, 0)}
