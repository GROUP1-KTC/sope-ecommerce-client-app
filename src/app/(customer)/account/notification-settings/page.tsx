            ...
            <div className="flex flex-col min-h-screen bg-gray-50 pl-12">
                <div className="flex flex-1">
                    <div className="flex-1 p-6 bg-white rounded-lg shadow-md my-6">
                        <h2 className="text-xl font-semibold text-black uppercase mb-6">Cài đặt thông báo</h2>
                        <hr className="my-4 border-gray-300" />
                        <div className="mb-8 px-10">
                            <h3 className="font-semibold text-lg mb-1">Email thông báo</h3>
                                ...
                                {emailSettings.map((item, idx) => (
                                    <li key={idx} className="flex justify-between items-center">
                                        <div>
                                            ...
                                            <p className="text-sl text-gray-500">{item.description}</p>
                                        </div>
                                        <label className="relative inline-flex items-center cursor-pointer">
                                            <input
                                                ...
                                                onChange={() => toggleEmailSetting(idx)}
                                            />
