        ...
        <div className="space-y-6">
            ...
            <div className="flex gap-6">
                ...
                <div className="w-1/3 bg-white rounded-lg shadow p-6 flex flex-col justify-between">
                    ...
                    <button className="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 text-sm self-start">
                        Xem chi tiết
                    </button>
                </div>
            </div>
            ...
            <div className="flex gap-6">
                ...
                <div className="w-1/3 bg-white rounded-lg shadow p-6">
                    ...
                    <div className="bg-blue-50 rounded p-3 flex items-center gap-3 mb-2">
                        <div className="w-16 h-16 bg-blue-200 rounded flex items-center justify-center text-2xl font-bold text-blue-600">
                            AD
                        </div>
                        <div>
                            <div className="font-semibold text-sm">
                                Tất tần tật tính năng Shopee Live
                            </div>
                            <div className="text-xs text-gray-500">
                                Xem ngay các tính năng nổi bật của Shopee Live
                                tại đây
                            </div>
                    ...
                    <div className="bg-blue-50 rounded p-3 flex items-center gap-3">
                        ...
                        <div>
                            <div className="font-semibold text-sm">
                                Chính sách mới về vận chuyển
                            </div>
                            <div className="text-xs text-gray-500">
                                Cập nhật chính sách vận chuyển mới nhất từ
                                Shopee
                            </div>
                            <div className="text-xs text-gray-400 mt-1">
                                Hôm Qua 18:00
