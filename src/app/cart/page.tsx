...
const mockCartItems = [
  {
    ...
    image:
      "https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcQe42ZXWwPudaJhV7R_FllhgDf3grwZ9QnVKFZ3vq9mgITZCuaYwUkTnTEpWqK1oxdHHMrVlWLzvAjgRdhH0MXRw3n1qHD3HpGNEOiZTrLapkQPc-jMt0Wv",
    price: 30000,
    quantity: 1,
  },
  {
    ...
    name: "Thẻ nhớ tải nhạc 2gb 4gb,8gb",
    image:
      "https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-m0cgbhue08od57@resize_w160_nl.webp",
    price: 28000,
    quantity: 3,
  },
];
...
const products = [
  ...
  },
  {
    ...
    image:
      "https://encrypted-tbn2.gstatic.com/shopping?q=tbn:ANd9GcRN4fZLY68H9tW_5H0U56PLyrrQDnPI_OdCnnrwoZMUpPqF5fhFiz_VkUho0vUWiF3qYYMpF0bI7JcniGIkXER15S5JtfpyTr9909e76ui9lLpStKqDwAsrzYDybhMpy7B3Rn5Glw&usqp=CAc",
    price: 22900,
  },
  {
    id: 104,
    ...
    image:
      "https://lh5.googleusercontent.com/proxy/anOm5cTCWfO5wDbMJp-mFxBSJ73jasabf3WKBxVQmlNBHDRZavndHwtLJWE2SuaX7MDYt-ZPJ20vy0qunLXBHJZQPRhqI5ei-YF7Iw4sqWqf9dScAM7Mgb1qWllvFwPPKySJXhWaYIRc7AM2Zi9d3kYf7R6wQ_YOWPoovivAVtfLHUi1xAn8SRRleb79Ef5x-6xCv1m7heP0CBE",
    price: 5000,
  },
];
...
const Cart = () => {
  ...
  const handleDeleteSelected = () => {
    ...
    setCartItems((prev) => prev.filter((item) => !selected.includes(item.id)));
